...
public class MsDCLDependencyAST extends ASTVisitor {
	
	private List<ConstraintDefinition> dependencies;

	private ICompilationUnit unit;
	private CompilationUnit fullClass;
	private String className;

	public MsDCLDependencyAST(ICompilationUnit unit) throws MsDCLException {
		try{
			this.dependencies = new ArrayList<ConstraintDefinition>();
			this.unit = unit;
	...
	public final List<ConstraintDefinition> getDependencies() {
