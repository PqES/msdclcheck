...
import enoir.graphvizapi.exception.AttributeNotFondException;
 ...
 * description. Created by frank on 2014/11/19.
 */
public abstract class BaseGraphObject {
	...
	/**
	 * Remove attribute by attribute name. If this graph object has two or more
	 * attribute with same name, it will remove them.
	 * 
	 * @param attributeName
	 */
	...
	protected String genAttributeEdgeDotString(){
