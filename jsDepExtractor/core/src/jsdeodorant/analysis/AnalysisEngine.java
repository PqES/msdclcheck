...
import jsdeodorant.analysis.util.JSONReader;
...
import jsdeodorant.experiment.PostgresOutput;
import jsdeodorant.metrics.CyclomaticComplexity;
...
public class AnalysisEngine {
	...
	public Set<Module> run(AnalysisOptions analysisOption) {
		...
		/*	if (analysisOption.isOutputToDB()) {
				psqlOutput.log.moduleInfo(module);
				if (analysisOption.hasClassAnlysis())
					psqlOutput.log.classes(module);
				if (analysisOption.hasFunctionAnlysis())
					psqlOutput.log.functions(module);
			}*/
